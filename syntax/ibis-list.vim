...
syntax match ibis_table_mail    /^|.\{-}|.\{-}|/              contains=ibis_table_flag,ibis_table_mail,ibis_separator
syntax match ibis_table_subject /^|.\{-}|.\{-}|.\{-}|/        contains=ibis_table_flag,ibis_table_mail,ibis_table_subject,ibis_separator
syntax match ibis_table_date    /^|.\{-}|.\{-}|.\{-}|.\{-}|$/ contains=ibis_table_flag,ibis_table_mail,ibis_table_subject,ibis_table_date,ibis_separator
